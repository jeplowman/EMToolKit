...
def xrt_wrapper(maps_in, temp_step_size=0.15):
	...
	for i in range(0,len(maps_in)):
		...
		[logt,tresp] = xrt_temperature_response(current_map, step_size=temp_step_size)
...
def xrt_temperature_response(map_in, step_size=0.2):
	channel = map_in.meta['ec_fw1_']+'_'+map_in.meta['ec_fw2_']
